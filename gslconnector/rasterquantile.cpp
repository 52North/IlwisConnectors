...
Ilwis::OperationImplementation::State RasterQuantile::prepare(ExecutionContext *ctx, const SymbolTable &)
{
    try{
...
{
    OperationResource operation({"ilwis://operations/quantile"});
