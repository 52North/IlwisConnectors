...
Ilwis::OperationImplementation::State GaussianBlurFilter::prepare(ExecutionContext *ctx, const SymbolTable &)
{
    try{
...
{
    OperationResource operation({"ilwis://operations/gaussianglurfilter"},"opencv");
    ...
    operation.addInParameter(3,itDOUBLE , TR("sigmay"),TR("gaussian kernel standard deviation in Y direction. If set to 0, the SigmaX value is taken optional"));
