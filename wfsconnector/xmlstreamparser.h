...
public:
    ...
    /**
     * Moves to next element named by qName. Optionally a callback can be passed in
    ...
    /**
     * Finds the next element named by one of the qNames in the elementList. Optionally
